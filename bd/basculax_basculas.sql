...
CREATE TABLE `basculas` (
  `Idbascula` int NOT NULL AUTO_INCREMENT,
  `CodBascula` varchar(50) DEFAULT NULL,
...
INSERT INTO `basculas` VALUES (1,'BC001','Báscula de compras'),(2,'BC002','Báscula de traslados'),(3,'BC003','Báscula de exportaciones');
